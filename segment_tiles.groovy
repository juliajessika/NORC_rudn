...
// Call Python
// ==========================
def pythonScript = buildFilePath(PROJECT_BASE_DIR, "nondummy_segmentation.py")
def condaExe = "C:/Users/julia/anaconda3/Scripts/conda.exe"
...
if (exitCode != 0) {
    print "❌ Python script failed with exit code ${exitCode}"
    return
}
...
if (!annotationsToAdd.isEmpty()) {
    ...
    print "✅ Added ${annotationsToAdd.size()} annotations to QuPath."
} else {
